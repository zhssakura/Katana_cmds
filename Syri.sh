...
mkdir ~/mypython352env
python3 -m venv --system-site-packages ~/mypython352env
source ~/mypython352env/bin/activate
pip3 install BioSAK

# install syri
module load python/intel-3.5.2
source ~/mypython352env/bin/activate
...
cd /srv/scratch/z5039045/syri_wd
...
module load python/3.6.5
source ~/mypython352env/bin/activate
PATH_TO_SYRI="/srv/scratch/z5039045/Softwares/syri/syri/bin/syri"
PATH_TO_PLOTSR="/srv/scratch/z5039045/Softwares/syri/syri/bin/plotsr"

/srv/scratch/z5039045/Softwares/syri/syri/bin/syri -c G1.sam
...
PATH_TO_SYRI="/srv/scratch/z5039045/Softwares/syri/syri/bin" #Change the path to point to syri executable
