...
/srv/scratch/z5095298/software/megahit/bin/megahit -1 CY_R1_P.fastq -2 CY_R2_P.fastq -r CY_R1_UP.fastq,CY_R2_UP.fastq -o megahit_1.2.9_test --k-min 57 --k-max 141 --k-step 28 --memory 50 -t 12


cd /srv/scratch/z5095298/Kelp_coassembly
/srv/scratch/z5095298/software/megahit/bin/megahit -1 BH_ER_pairedForward.fastq,BI_ER_pairedForward.fastq,CB_ER_pairedForward.fastq,SH_ER_pairedForward.fastq -2 BH_ER_pairedReverse.fastq,BI_ER_pairedReverse.fastq,CB_ER_pairedReverse.fastq,SH_ER_pairedReverse.fastq -r BH_ER_unpairedForward.fastq,BH_ER_unpairedReverse.fastq,BI_ER_unpairedForward.fastq,BI_ER_unpairedReverse.fastq,CB_ER_unpairedForward.fastq,CB_ER_unpairedReverse.fastq,SH_ER_unpairedForward.fastq,SH_ER_unpairedReverse.fastq -o Kelp_coassembly_megahit_1.2.9 --k-min 57 --k-max 141 --k-step 28 --memory 1200 -t 32
